...
function fx_sqrt(x: integer): integer;
var
  lo: integer;
  hi: integer;
  mid: integer;
...
function fx_sin(a: integer): integer;
var
  d: integer;
  s: integer;
begin
...
function fx_cos(a: integer): integer;
begin
  fx_cos := fx_sin(90 - a)
end;

function fx_tan(a: integer): integer;
var
  c: integer;
begin
  c := fx_cos(a);
  if c = 0 then
    ...
    fx_tan := m_div(fx_sin(a) * 10000, c)
end;

function fx_asin(v: integer): integer;
var
  i: integer;
  besti: integer;
  beste: integer;
...
function fx_acos(v: integer): integer;
begin
  fx_acos := 90 - fx_asin(v)
end;

function fx_atan(v: integer): integer;
var
  i: integer;
  besti: integer;
  beste: integer;
...
function fx_ln(x: integer): integer;
var
  xn: integer;
  y: integer;
  y2: integer;
...
function fx_log(x: integer): integer;
begin
  fx_log := m_div(fx_ln(x) * 10000, 23026)
end;
